# TrainPNR — Google Play Data Safety Form Reference
...
- **Users can request deletion:** Contact privacy@trainpnr.game; local data cleared via app settings or uninstall

#!/usr/bin/env python3
"""Generate TrainPNR Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\TrainPNR")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "trainpnr"
TEST = APP / "src" / "test" / "java" / "com" / "trainpnr"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "trainpnr"
...
android {
    namespace = "com.trainpnr"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.trainpnr.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "trainpnr-game",
    "storage_bucket": "trainpnr-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.trainpnr.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating TrainPNR project files...")
